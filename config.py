...
Command: **/yplay**
__First get a playlist file from @songstore0 and reply to playlist file.__
...
You can also use YouTube Playlist.Find a Telegram Link for your playlist from [PlayList Dumb](https://telegram.dog/mukhushi_official) or get a PlayList from [PlayList Extract](https://telegram.dog/mukhushi_official). 
